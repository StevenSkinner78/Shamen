...
var ShamenTheme = Theme.extend({
    ...
    classes: {
        ...
        today: 'alert alert-dark', // the plain `info` class requires `.table`, too much to ask

        popover: 'panel panel-primary',
        popoverHeader: 'panel-heading',
        popoverContent: 'panel-body',

        // day grid
        headerRow: 'panel-primary', // avoid `panel` class b/c don't want margins/radius. only border color
        dayRow: 'panel-primary', // "

        // list view
        listView: 'panel panel-primary'
    },

    baseIconClass: 'fa fa-fw',
    iconClasses: {
        close: 'fa-remove',
    ...
    iconOverrideOption: 'fa',
    iconOverrideCustomButtonOption: 'fa',
    iconOverridePrefix: 'fa-'

});

ThemeRegistry.register('shamenTheme', ShamenTheme);
