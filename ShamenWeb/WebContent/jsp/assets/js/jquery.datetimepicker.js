    ...
    function DateTimePicker(element, options){
        var picker = {},
            ...
            _createMonthPicker = function () {
                ...
                _createCell($row, '<i class="fa fa-chevron-right"/>', 1, NAV['nexty'], ' nexty');
                //tbody - years
                for (var m = 0; m < 5; m++) {
            ...
            _createTimePicker = function (viewmode) {
                ...
                var $tbody = $('<tbody>').appendTo($table);
                $table.$h = $('<input type="number" min="0" max="23" maxlength="2" class="enableWithRestrict"/>').data('time', 'h').change(function () {
                ...
                $table.$m = $('<input type="number" min="0" max="59" maxlength="2" class="enableWithRestrict"/>').data('time', 'm').change(function () {
                    var value = parseInt(this.value, 10);
                ...
                $table.focus = $table.$m;
                var $add = $('<td/>').append($('<i class="fa fa-chevron-up"/>')).data('nav', NAV['plus']);
                var $min = $('<td/>').append($('<i class="fa fa-chevron-down"/>')).data('nav', NAV['minus']);
