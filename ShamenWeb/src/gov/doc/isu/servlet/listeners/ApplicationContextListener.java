 ...
 * <p>
 * This class handles 2 lifecycle changes. They are <b>context destroyed</b> which would occur on shutdown of the web application and <b>context initialized</b> which would occur on start up of the web application. This <code>ApplicationContextListener</code> allows the application to release any system resources on shutdown or to obtain any resources needed on startup.
 * </p>
 *
...
public class ApplicationContextListener implements ServletContextListener {
     ...
     * </p>
     * <p>
     * This method is utilitzed for releasing any system resources that may be holding locks on any application logging files.
     * </p>
     * 
     * @param sce
