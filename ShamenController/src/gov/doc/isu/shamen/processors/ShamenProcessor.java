...
import gov.doc.isu.shamen.dao.ShamenDAO;
 ...
 */
public class ShamenProcessor {
    private static final String MY_CLASS_NAME = "gov.doc.isu.shamen.processors.ShamenProcessor";
    ...
    private ShamenDAO shamenDAO = null;
     ...
     * @author <strong>Shane Duncan</strong> JCCC, Sep 10, 2015
     */
    public ShamenProcessor(Logger inLogger) {
        isThread = true;
    ...
    private ShamenDAO getDAO() {
        ...
        if(shamenDAO == null){
            if(isThread){
                ...
                shamenDAO = ShamenDAO.getInstance(myLogger);
            }else{
                shamenDAO = ShamenDAO.getInstance();
            }// end else-if
        }// end if
    ...
    public void insertMessage(ControllerMessage message) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "Exception encountered while tyring to serialize message. Message is: " + e.getMessage(), e);
        }catch(IOException e){
            myLogger.log(Level.SEVERE, "Exception encountered while tyring to serialize message. Message is: " + e.getMessage(), e);
            appLogger.getChild().log(Level.SEVERE, "Exception encountered while tyring to serialize message. Message is: " + e.getMessage(), e);
        }// end try-catch
        ...
        if(message != null){
            if(message.getMessageBytes() != null){
                ...
                try{
                    ...
                    appLogger.getChild().log(Level.SEVERE, "Exception encountered while tyring to de-serialize message. Message is: " + e.getMessage(), e);
                }catch(IOException e){
                    myLogger.log(Level.SEVERE, "Exception encountered while tyring to de-serialize message. Message is: " + e.getMessage(), e);
                    appLogger.getChild().log(Level.SEVERE, "Exception encountered while tyring to de-serialize message. Message is: " + e.getMessage(), e);
    ...
    public List<Message> processArchivedMessages() {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "An Exception has been caught while trying to send the message to shamen to update the runStatus record. Message is: " + e.getMessage(), e);
        }finally{
            if(jms != null){
                jms.cleanUp();
            }// end if
    ...
    public Properties getProperties() {
        ...
        ShamenDAO dao = getDAO();
        Properties p = dao.getProperties();
