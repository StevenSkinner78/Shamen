...
public class ShamenDAO {
    ...
    private static final String MY_CLASS_NAME = "gov.doc.isu.shamen.dao.ShamenDAO";
     ...
     */
    public static synchronized ShamenDAO getInstance() {
        ShamenDAO shamenDAO = new ShamenDAO(Logger.getLogger(MY_CLASS_NAME));
        return shamenDAO;
    }// end getInstance
     ...
     * @return shamenDAO A static instance of this class.
     */
    public static synchronized ShamenDAO getInstance(Logger inLogger) {
        ShamenDAO shamenDAO = new ShamenDAO(inLogger);
        return shamenDAO;
    }// end getInstance
     ...
     */
    public ShamenDAO(Logger inLogger) {
        super();
        if(inLogger == null){
    ...
    public void initializeInternalDB() {
        ...
        try{
            ...
            myLogger.finer("Successfully initialized internal DB.");
        }catch(Exception e){
            myLogger.log(Level.SEVERE, "A SQLException was caught while trying to initialize the internal DB. Message is: " + e.getMessage(), e);
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to initialize the internal DB. Message is: " + e.getMessage(), e);
        }// end try/catch
    ...
    public void initializePropertiesAndRunStatus() {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to initialize Properties and RunStatus tables. Message is: " + e.getMessage(), e);
        }// end try-catch
    ...
    public void insertController(JmsController controllerModel) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to insert the controller record. Message is: " + e.getMessage(), e);
        }// end try-catch
        myLogger.exiting(MY_CLASS_NAME, methodName);
    ...
    public void insertProperties(Properties properties) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to insert the properties record. Message is: " + e.getMessage(), e);
        }// end try-catch
        myLogger.exiting(MY_CLASS_NAME, methodName);
    ...
    public Message getMessageById(String id) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to select the message record. Message is: " + e.getMessage(), e);
        }// end try-catch
        try{
            if(rs.next()){
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the message record. Message is: " + e.getMessage(), e);
    ...
    public List<Message> getAllMessages() {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to select all the message records. Message is: " + e.getMessage(), e);
        }// end try-catch
        try{
            while(rs.next()){
                Message m = new Message();
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get all the message records. Message is: " + e.getMessage(), e);
        }finally{// kill the reference to the result set to free memory
            rs = null;
        }// end try-catch
        myLogger.info("Number of messages found in the DB: " + (null != messageList ? messageList.size() : "0"));
    ...
    public void deleteMessage(Message message) {
        ...
        try{
            ...
            ps.execute();
            myLogger.info("          Successfully executed query ");
        }catch(SQLException e){
            myLogger.log(Level.SEVERE, "A SQLException was caught while trying to delete a message record. Message is: " + e.getMessage(), e);
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to delete a message record. Message is: " + e.getMessage(), e);
        }// end try/catch
        myLogger.exiting(MY_CLASS_NAME, methodName);
    }// end deleteMessage
    ...
    public void insertMessage(Message m) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to insert the message record. Message is: " + e.getMessage(), e);
        }// end try-catch
        myLogger.exiting(MY_CLASS_NAME, methodName);
    }// end insertProperties
    ...
    public Properties getProperties() {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the properties record. Message is: " + e.getMessage(), e);
        }// end try-catch
        try{
            if(rs.next()){
    ...
    public void updateProperties(Properties inProperties) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to update the properties record. Message is: " + e.getMessage(), e);
        }// end try-catch
        myLogger.exiting(MY_CLASS_NAME, methodName);
    ...
    public void insertBatchApp(JmsBatchApp batchApp) {
        ...
        if(getBatchAppByBatchAppRefId(batchApp.getBatchAppRefId()) == null){
            ...
            try{
                ...
                appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to insert the batchApp record. Message is: " + e.getMessage(), e);
            }// end try-catch
        }else{
    ...
    public void insertSchedule(JmsSchedule schedule) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to insert the schedule record. Message is: " + e.getMessage(), e);
        }// end try-catch
        myLogger.exiting(MY_CLASS_NAME, methodName);
    }// end insertSchedule
    ...
    public JmsController getController(String controllerName) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the controller record. Message is: " + e.getMessage(), e);
        }// end try/catch
        try{
            if(rs.next()){
    ...
    public List getBatchAppsForController() {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the batch apps for a controller record. Message is: " + e.getMessage(), e);
        }// end try/catch
        try{
            while(rs.next()){
    ...
    public List getBatchCollectionsForController() {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the batch collections for a controller record. Message is: " + e.getMessage(), e);
        }// end try/catch
        try{
            while(rs.next()){
    ...
    public JmsBatchApp getBatchAppByBatchAppRefId(Long batchAppRefId) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the batch apps record. Message is: " + e.getMessage(), e);
        }// end try/catch
        try{
            if(rs.next()){
                batchApp = new JmsBatchApp();
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the batchapps record. Message is: " + e.getMessage(), e);
        }finally{// kill the reference to the result set to free memory
            rs = null;
        }// end try-catch
    ...
    public List<JmsSchedule> getScheduleForBatchApp(Long batchAppRefId) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the Schedule for a BatchApp record. Message is: " + e.getMessage(), e);
        }// end try/catch
        try{
            while(rs.next()){
    ...
    public JmsRunStatus getMostRecentRunStatusForSchedule(Long scheduleRefId) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the most recent runStatus for a schedule record. Message is: " + e.getMessage(), e);
        }// end try/catch
        try{
            if(rs.next()){
    ...
    public JmsRunStatus insertRunStatus(JmsRunStatus runStatus) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to insert the runStatus record. Message is: " + e.getMessage(), e);
        }// end try/catch
    ...
    public JmsRunStatus updateRunStatus(JmsRunStatus runStatus) {
        ...
        try{
            ...
            appLogger.getChild().log(Level.SEVERE, "A SQLException was caught while trying to get the update the runStatus record. Message is: " + e.getMessage(), e);
        }// end try-catch
        myLogger.exiting(MY_CLASS_NAME, methodName, runStatus);
        return runStatus;
    }// end updateRunStatus
